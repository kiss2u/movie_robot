...
class TaskMeta:
    ...
    def __init__(self, task: Task, name, desc, cron_expression=None, jitter=None, minutes=None, seconds=None):
        self.task = task
        self.name = name
        self.desc = desc
...
class _TaskManager:
    ...
    def register(self, name, desc, cron_expression=None, jitter=None, minutes=None, seconds=None):
        ...
        def decorator(t):
            ...
            self._tasks.update({name: TaskMeta(task, name, desc, cron_expression, jitter, minutes, seconds)})
            return t
